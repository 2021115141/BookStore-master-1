                    ...
                    echo '<div class="container">
                     ...
                     echo '<div class="row">
                             ...
                             <div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-1 col-lg-4 ">
                                  ...
                                  <button type="button" class="btn btn-lg" data-toggle="modal" data-target="#payment"style="background:#D67B22;color:white;font-weight:800;margin-top:5px;">Place Order</Button>
                                  ';?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                              ...
                                              <div class="form-group">
                                                  <a href="payment-cod.php"><button type="button" class="btn btn-block">
                                                      CASH ON DELIVERY
                                                  </button></a>
                                              </div>
                                              <div class="form-group">
                                                  <a href="payment-visa.php"><button type="button" class="btn btn-block">
                                                      VISA
                                                  </button></a>
                                              </div>
