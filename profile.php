      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nickname" value="<?=$row['nickName']?>" disabled>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Full Name</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="fullname" value="<?=$row['Fullname']?>"disabled>
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="tel" class="form-control" value="<?=$row['phoneNum']?>"disabled>
            </div>
          </div>
          <div class="form-group">
       ...
       <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
              ...
              <a href="index.php"><button type="button" class="btn btn-default">Back to Homepage</button></a>
            </div>
          </div>
